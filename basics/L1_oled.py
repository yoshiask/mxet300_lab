...
def getVoltage():
    ...
    ##########################################
    return ina219.readVolts() # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "Reboot", font=font, fill=255)
    ...
    #################################################
    draw.text((0, 40), f"Voltage: {getVoltage()} V", font=font, fill=255)
